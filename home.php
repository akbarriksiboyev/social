...
<div>
    <div id="editwindow">
        ...
        <form action="#" method="POST" style="margin-left:5%;">    
                ...
                <input type="text" placeholder="Address" name="mest_jit" value="<?php echo($info->location);?>"><br>
                <input type="text" placeholder="birthplace" name="rodil" value="<?php echo($info->born);?>"><br>
                <input type="text" placeholder="Workplace" name="rab" value="<?php echo($info->job);?>"><br>
                <input type="text" placeholder="Education" name="uch" value="<?php echo($info->study);?>"><br>
                <input type="text" placeholder="Family condition" name="polog" value="<?php echo($info->type);?>"><br>
                <input type="text" placeholder="Hobby" name="evlech" value="<?php echo($info->hobby);?>"><br>
                <input type="submit" value="Save" style="width:90%;" name="go_user_save">
        </form>
